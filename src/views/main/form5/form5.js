    ...
    return (
        <div className='content__brand'>
            ...
            <div className='content__brand--bottom'>
                <div className='brand__Window--border'></div>
                <div className='brand__Window--border'></div>
                <div className='brand__Window'>
                    <div className='brand__Window--left'></div>
                    <div className='brand__Window--right'><div className='brand__text'>
